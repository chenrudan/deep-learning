...
if(epoch_idx == 40){
	softmax1.changeLrDownScale(0.9);
}
...
*/
	...
	layer_pars[0].w_lr = 1;
	layer_pars[0].b_lr = 0.5;
	layer_pars[0].lr_down_scale = 0.8;
	layer_pars[2].w_lr = 0.1;
	layer_pars[2].b_lr = 0.5;
	...
	layer_pars[5].b_lr = 0.005;
	layer_pars[5].lr_down_scale = 0.8;
