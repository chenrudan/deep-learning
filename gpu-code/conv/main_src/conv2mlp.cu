...
*/
	...
	if(rank == 1){
		...
		t = clock();
			...
			savePars(cnn1_w, "./pars/cnn1_w_t2.bin");
	savePars(cnn1_y, "./pars/cnn1_y_t2.bin");	
//	savePars(cnn2_y, "./pars/cnn2_y_t2.bin");	
...
*/
	...
	layer_pars[4].b_lr = 0.2;
	layer_pars[5].w_lr = 0.005;
