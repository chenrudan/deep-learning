...
void managerNode(TrainClassification<float> *model){
	...
	string str1[6]= {"../snapshot/w_snap/130_inner1_w.bin", \
		"../snapshot/w_snap/130_inner2_w.bin", \
		"../snapshot/w_snap/130_inner2_w.bin"};
	vector<string> w_file(str1, str1+5);
	string str2[6]	= {"../snapshot/w_snap/130_inner1_bias.bin", \
		"../snapshot/w_snap/130_inner2_bias.bin", \
		"../snapshot/w_snap/130_inner3_bias.bin"};
