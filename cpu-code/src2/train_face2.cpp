...
int main(int argc,char **argv){
    ...
    //输入相关
    const int input_row=88;
    const int input_col=88;
    const int input_channel=3;
    const string inputFileName="face1_lc_t9.dat";
    ...
    HPC firstlayer(rank,process_number,processor_name,input_row,input_col,input_channel,inputFileName, \
            picture_number,filter_row,filter_col,step_size,hidden_block_row,hidden_block_col,hidden_channel,pooling_row,pooling_col);
    ...
    const float u=0.005;
    const string outfilename="face2_w_t1.dat";
    const string h_filename="face2_h_t1.dat";
    const string p_filename="face2_p_t1.dat";
    const string lcn_filename="face2_outcome_t1.dat";
    const string R_0_file="face2_R0_t1.dat";
    const string R_n_file="face2_Rn_t1.dat";
    if(rank==0){
        cout<<"************************************************"<<endl;
        cout<<"-----------train_face2--------"<<endl;
    ...
    //read w
    if(rank == 0){
        firstlayer.loaddata_w("499face2_w_t1.dat");
    }
    //read w and bcast
